...
@Component({
  selector: 'Complaint-home',
  templateUrl: './Complaint-home.component.html',
  styleUrls: ['./Complaint-home.component.scss']
})
export class ComplaintHomeComponent implements AfterViewInit {
