...
@Component({
  selector: 'DogWalk-home',
  templateUrl: './DogWalk-home.component.html',
  styleUrls: ['./DogWalk-home.component.scss']
})
export class DogWalkHomeComponent implements AfterViewInit {
