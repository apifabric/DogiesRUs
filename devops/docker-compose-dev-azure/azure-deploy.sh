...
resourcename="dogiesrus"  # lower case, only
resourcegroup="dogiesrus_rg"
...
# git clone https://github.com/apilogicserver/dogiesrus.git
# cd dogiesrus
...
az group create --name dogiesrus_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dogiesrus_rg --sku S1 --is-linux
az container create --resource-group dogiesrus_rg --name dogiesrus --image apilogicserver/dogiesrus:latest --dns-name-label dogiesrus --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dogiesrus.westus.azurecontainer.io:5656'
